...
from userextend.forms import AuthenticationNewForm, PasswordChangeNewForm, PasswordResetNewForm, \
    PasswordResetDoneNewForm
...
urlpatterns = [
    ...
    path("reset/<uidb64>/<token>/",views.PasswordResetConfirmView.as_view(form_class=PasswordResetDoneNewForm), name="password_reset_confirm"),
