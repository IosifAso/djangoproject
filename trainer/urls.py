...
urlpatterns = [
    path('trainer/', views.TrainerCreateView.as_view(), name='create-trainer'),
    ...
    path('details_of_trainer/<int:pk>', views.TrainerDetailView.as_view(), name='details-of-trainer'),
]